...
while True:
    ...
    for i in range(len(section_joints)) :
        ...
        #phase = -2 * m_waveAmplitude * math.sin( m_curveNumber / m_segmentNumber * math.pi  ) * math.sin( 2.0 * math.pi * m_curveNumber / m_waveLength * t - 2.0 * math.pi *  m_curveNumber / m_segmentNumber * i) 
